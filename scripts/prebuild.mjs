...
// =======================
// FORK: keep service binaries aligned with the Cargo.lock client crate; releases/latest can change IPC paths.
const SERVICE_VERSION = 'v2.3.3'
...
async function getPinnedServiceVersion() {
